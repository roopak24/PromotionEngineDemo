...
{
    public class OrderWithOrderItems_PromotionsExist_CombinationBasedPromotionAppliesOnce_NoLeftOverOrderItemsWherePromotionApplied_TestData : IEnumerable<object[]>
    {
